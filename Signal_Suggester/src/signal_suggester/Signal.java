...
public class Signal {
    ...
    private void fetch_data(String Ticker, int TimeDuration) throws Exception{
...
//        Process p_save = Runtime.getRuntime().exec(command_save);
    ...
    public static void main(String[] args){
        ...
        try
        {
            obj.fetch_data("TATAPOWER.NS", 365);
        }
        catch(Exception e){}
        System.out.print(obj.epoch());
        System.out.println("Size: " + obj.close_price.size());
        System.out.println(obj.close_price.get(obj.close_price.size()-1));
        obj.sma_calculate(20, 50);
        obj.ema_calculate(20, 50);
        System.out.println(obj.first_sma.size());
        System.out.println(obj.second_sma.size());
        System.out.println(obj.first_ema.size());
        System.out.println(obj.second_ema.size());
        System.out.println(obj.second_sma.get(obj.second_sma.size() - 1));
        System.out.println(obj.second_ema.get(obj.second_ema.size() - 1));
        obj.SMA_Signal_Find();
        obj.EMA_Signal_Find();
        obj.Final_Signal_Find();
        System.out.println(obj.SMA_Signal.size());
        System.out.println(obj.EMA_Signal.size());
        System.out.println(obj.SMA_Signal.get(obj.SMA_Signal.size() - 1));
        System.out.println(obj.EMA_Signal.get(obj.EMA_Signal.size() - 1));
        System.out.println(obj.Final_Signal);
    }
}
