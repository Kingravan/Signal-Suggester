...
public class Currencies implements ActionListener{
    Connection con= null;
    Statement stmt = null;
    ...
    Currencies()
    {
        ...
        hint1 = new JLabel("To add multiple Ticker add coma (,) Eg.(INRUSD, JPYINR)");
        hint2 = new JLabel("To get result for USD Pair enter currency name Eg.(INR, JPY)");
        ...
        hint1.setBounds(300, 130, 400, 20);
        hint2.setBounds(300, 150, 400, 20);
        ...
        frame.setTitle("Signal Suggester - Currencies");
    ...
    public void singleTicker(String Ticker, int FirstMA, int SecondMA, int FinalTimeFrame, String finalInterval){
        ...
        if(sma.isSelected() && ema.isSelected())
        {
            try
            {
                obj.fetch_data(Ticker.concat("=X"), FinalTimeFrame, finalInterval);
    ...
    public void multipleTicker(String[] List, int FirstMA, int SecondMA, int FinalTimeFrame, String finalInterval){
        ...
        if(sma.isSelected() && ema.isSelected())
        {
            for(String s : List)
            {
                try
                {
                    obj.fetch_data(s.concat("=X"), FinalTimeFrame, finalInterval);
                    obj.sma_calculate(FirstMA, SecondMA);
                    obj.ema_calculate(FirstMA, SecondMA);
                    obj.SMA_Signal_Find();
                    obj.EMA_Signal_Find();
